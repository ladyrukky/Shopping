...
public class ShoppingRunner {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    //whenever I try this section of the code, it doesn't print the array of customers
	    //I tried debugging further up to see what is in the array of allCustomers (lines 186 to 194)
